 ...
 * 
 * This is to make it easier to access the column names from the CSV file, without knowing the names
 * of the specific columns anywhere else in the program.
 * 
 * Throughout your program, you will use GameData when parsing anything that is associated with
 * column names (filter) and sorting.
 */
public enum GameData {
     ...
     * 
     * Can use the enum name or the column name. Useful for filters and sorts as they can use both.
     * 
